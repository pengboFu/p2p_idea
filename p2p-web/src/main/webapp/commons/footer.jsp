    ...
    <div class="homeWap">
      <div class="footer-section clearfix">
        ...
        <div class="footer-contactus">
          ...
          <p>客服邮箱：<a style="cursor:pointer;" onclick="location.href='mailto:www.baidu.com'">qiuqu@qiuqiuwang.com</a></p>
        </div>
        <div class="footer-ewm">
          <img src="${pageContext.request.contextPath}/images/weixin01.png" alt="球球金融网订阅号" />
          <p>球球金融网订阅号</p>
        </div>
        <div class="footer-ewm">
          <img src="${pageContext.request.contextPath}/images/weixin02.png" alt="球球金融网服务号" />
          <p>球球金融网服务号</p>
        </div>
      </div>
      <div class="copyright">版权所有 ©2017 广东球球科技有限公司   莞ICP备000000000号   |   <img src="${pageContext.request.contextPath}/images/jinghui.png" alt="莞公网安备" />莞公网安备1103000000000</div>
