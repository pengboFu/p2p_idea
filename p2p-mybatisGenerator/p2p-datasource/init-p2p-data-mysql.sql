...
CREATE TABLE IF NOT EXISTS `b_borrower_info` (
  ...
  `address` varchar(150) DEFAULT '0' COMMENT '现居地址',
  `industry` int(11) DEFAULT '0' COMMENT '工作行业（字典值）',
  `workCity` int(11) DEFAULT '0' COMMENT '工作城市（字典值）',
  `workYear` varchar(50) DEFAULT '0' COMMENT '工作年限',
  `yearSalary` varchar(50) DEFAULT '0' COMMENT '年薪',
  `housing` int(11) DEFAULT '0' COMMENT '房产情况（字典值）',
  `car` int(11) DEFAULT '0' COMMENT '车产情况（字典值）',
  `borrowReason` varchar(50) DEFAULT '0' COMMENT '借款缘由',
...
CREATE TABLE IF NOT EXISTS `b_deal_record` (
  ...
  `deal_desc` varchar(50) NOT NULL COMMENT '交易描述',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8 COMMENT='交易记录表';

INSERT INTO `b_deal_record` (`id`, `uid`, `deal_no`, `deal_status`, `deal_money`, `deal_time`, `deal_type`, `deal_desc`) VALUES
	(1, 1, 1501148611830, 1, 100, '2017-07-27 17:43:32', 2, '投资'),
	(2, 1, 1501148740027, 1, 100, '2017-07-27 17:45:40', 2, '投资'),
	(3, 1, 1501341987129, 1, 100, '2017-07-29 23:26:27', 1, '投资'),
	(4, 1, 1501495613441, 1, 100, '2017-07-31 18:06:53', 1, '投资'),
	(5, 1, 1501578643841, 1, 2, '2017-08-01 17:10:44', 1, '投资'),
	(6, 1, 1501578712411, 1, 1, '2017-08-01 17:11:52', 1, '投资'),
	(7, 1, 1501578720410, 1, 1, '2017-08-01 17:12:00', 1, '投资'),
	(8, 1, 1502023841765, 1, 100, '2017-08-06 20:50:42', 1, '投资'),
	(9, 1, 1502024284254, 1, 100, '2017-08-06 20:58:04', 1, '投资'),
	(10, 1, 1502523645669, 1, 100, '2017-08-12 15:40:46', 1, '投资'),
	(11, 1, 1502530470157, 1, 100, '2017-08-12 17:34:30', 1, '投资'),
	(12, 1, 1502530563922, 1, 100, '2017-08-12 17:36:04', 1, '投资'),
	(13, 1, 1502530594779, 1, 100, '2017-08-12 17:36:35', 1, '投资');
...
CREATE TABLE IF NOT EXISTS `u_user` (
  ...
  `idCard` varchar(18) COMMENT '用户身份证号码',
  `addTime` datetime COMMENT '注册时间',
  `lastLoginTime` datetime COMMENT '最近登录时间',
  `headerImage` varchar(50) COMMENT '用户头像文件路径',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8 COMMENT='用户表';

INSERT INTO `u_user` (`id`, `phone`, `loginPassword`, `name`, `idCard`, `addTime`, `lastLoginTime`, `headerImage`) VALUES
